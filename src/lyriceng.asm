...
.const SPR   = $2a00          // lines 0..27 here (28*192=5376B, ends $3eff)
.const SPR2  = $c000          // lines 28.. here (overflow region)
.const THRESH = 28
.const ONSET = $3f00          // LYRIC_NLINES x 2 bytes (LE PAL frame stamp)
